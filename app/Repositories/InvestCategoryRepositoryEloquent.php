 ...
 */
class InvestCategoryRepositoryEloquent extends BaseRepository implements InvestCategoryRepository
{
    /**
    ...
    public function update(array $input, $id)
    {
        ...
        foreach($locales as $locale){
            if(!empty($input[$locale]['slug'])){
                ...
                DB::table('invest_category_translation')
                    ->where('invest_category_id', $id)->where('locale', $locale)
                    ->update(['slug' => $slug]);
            }
        }
        return $model;
