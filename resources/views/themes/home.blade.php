                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-lg-11 pl-0">
                                    <h3 class="sub-title" data-waypoint="100%">
                                        {{ trans('home.CONTENT.subTitle_story_1') }} </br>
                            ...
                            <div class="row py-4">
                                ...
                                <div class="col-lg-11 pl-0">
                                    <button type="button" name="" id=""
                                        class="btn btn-gray btn-md ">{{ trans('home.readmoreUP') }}</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="container pb-5">
            ...
            <li>Smart window (window allows color change on Boeing plane) </li>
                            ...
                            <a href="{{ route('page.show', ['slug' => 'our-products/tungsten']) }}"
                                class="btn btn-gray btn-xs ">{{ trans('home.readmoreDOWN') }}</a>
                        </div>
                    </div>
                </div>
                <div class="product-list-item row">
            ...
            <li>Fabrication of microscopic lenses, cameras, telescopes
                            ...
                            <a href="{{ route('page.show', ['slug' => 'our-products/flourspar']) }}"
                                class="btn btn-gray btn-xs ">{{ trans('home.readmoreDOWN') }}</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-7 col-md-6">
            ...
            <li>Manufacturing semiconductors in computers, phones, television
                            ...
                            <a href="{{ route('page.show', ['slug' => 'our-products/bismuth']) }}"
                                class="btn btn-gray btn-xs ">{{ trans('home.readmoreDOWN') }}</a>
                        </div>
                    </div>
                </div>
            ...
            <li>Fabrication of cosmetics such as eyeshadow, hair spray, nail polish
                            ...
                            <a href="{{ route('page.show', ['slug' => '/our-products/copper']) }}"
                                class="btn btn-gray btn-xs ">{{ trans('home.readmoreDOWN') }}</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-7 col-md-6">
                            ...
                            <div class="col-md-6 col-sm-7 col-md-6 bg-white p-4">
                                @foreach ($latest_news as $item)
                                    <div class="itemNew my-2">
                                      <b class="title">{{ summary($item->title, 140) }}
                                        @if($loop->index == 0)
                                      ...
                                      @endif
                                        ...
                                        <a href="{{ route('media.news.detail', ['slug' => $item->slug]) }}"><span
                                                class="read-more">{{ trans('home.readmoreDOWN') }} <i
            ...
            <div class="container">
                ...
                <div id="our-businness-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators name-indicators">
                        <li data-target="#our-businness-carousel" data-slide-to="0" class="active">
                            {{ trans('home.CONTENT.about') }}
                        </li>
                        <li data-target="#our-businness-carousel" data-slide-to="1">{{ trans('home.CONTENT.products') }}
                        </li>
                        <li data-target="#our-businness-carousel" data-slide-to="2">
                            {{ trans('home.CONTENT.sustainability') }}</li>
                    </ol>
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
