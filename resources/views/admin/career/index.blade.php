...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.career.datatable') }}"/>
@endsection
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.career.create") !!}" class="btn btn-info waves-effect pull-right">
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable"  style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th>{!! trans("admin_career.table.career") !!}</th>
                        <th>{!! trans("admin_career.table.employer") !!}</th>
                        <th>{!! trans("admin_career.table.expired_date") !!}</th>
                        <th>{!! trans("admin_career.table.status") !!}</th>
                        <th>{!! trans("admin_career.table.is_top") !!}</th>
                        <th>{!! trans("admin_career.table.num_of_application") !!}</th>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/career.index.js?v=1.0"></script>
@endsection