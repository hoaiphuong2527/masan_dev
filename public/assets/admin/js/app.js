...
//Google Analiytics ======================================================================================
var googleTrackingId = false;

if(typeof googleTrackingId !== 'undefined' && googleTrackingId){
...
function installCkeditor(input_id) {
    let optionsCkfinder = {
        ...
        allowedContent: true,
        extraAllowedContent: 'div;span;ul;li;i;table;td;style;*[id];*(*);*{*};h1;h2;h3;h4;h5;h6',
    };
